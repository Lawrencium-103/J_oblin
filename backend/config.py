...
CRON_QUERIES = [
    "Data Analyst", "Project Manager", "Software Engineer", "Accountant",
    "Marketing Officer", "HR Officer", "Customer Service Officer",
    "Administrative Officer", "Sales Executive", "Public Health Officer",
    "Procurement Officer", "Legal Officer", "Graduate Trainee", "M&E Officer",
    "Civil Engineer", "Logistics Officer",
]
...
JOB_CATEGORIES = {
    ...
    "sales-marketing": {
        ...
        "keywords": ["sales executive","business development","sales manager","sales representative",
                      ...
                      "content writer","brand manager","public relations","communications officer",
